...
class LandingPage extends Component {
    ...
    render() {
        ...
        <nav className="navbar navbar-expand-lg navbar-light sticky-top" id="ImpNav">
            ...
            <button className="navbar-toggler navbar-toggler-right collapsed" type="button" data-toggle="collapse" data-target="#navbarNavDropdown" aria-controls="navbarNavDropdown" aria-expanded="false" aria-label="Toggle navigation">
                <span> </span>
                <span> </span>
                <span> </span>
            </button>
            <div className="collapse navbar-collapse" id="navbarNavDropdown">
                <ul className="navbar-nav">
                    ...
                    <li className="nav-item">
                        <a className="nav-link" href="#ourBlogs">Blogs</a>
                    </li>
                    <li className="nav-item">
                    ...
                    <li className="nav-item">
                        <a className="nav-link register-cta" href="#">Register</a>
                    </li>
                    ...
                    <div className="col-sm-12 col-md-12 col-lg-6">
                        <div className="content_bottom">
                            <h1 className="bold text_grey lh-50">
                                An intuitive <span className="text_blue">Image</span>,<br />
                                <span className="text_blue">Video</span> &amp; <span className="text_blue">Live Streaming</span><br />
                                Watermark Application<br />
                            </h1>
                            <p className="text_grey lh-35">Instantly protect and share your photos, live streaming &amp; videos
                                with a custom watermark built in. </p>
                            <div className="btn-block">
                                <button className="Imp_btn text_grey appStore" type="button" href="#" name="Appstore" vlaue="appstore">Apple Store</button>
                                <button className="Imp_btn text_grey playStore" type="button" href="#" name="playstore" vlaue="playstore">Play Store</button>
                            </div>
                        </div>
                    </div>
                    <div className="col-sm-12 col-md-12 col-lg-6">
                        <img className="Imp_app"
                ...
                <div className="row card_layout">
                    ...
                    <div className="col-sm-6 col-md-6 col-lg-3">
                        <div className="card_features">
                            ...
                            <p className="feature_name semibold text_grey">One App for Photo,Videos &amp; Live Streaming</p>
                            <p className="feature_details regular text_grey"> Easily choose photo, video or Live Streaming, and protect your intellectual property.</p>
                        </div>
                    </div>
                    <div className="col-sm-6 col-md-6 col-lg-3">
                        <div className="card_features">
                    ...
                    <div className="col-sm-6 col-md-6 col-lg-3">
                        <div className="card_features">
                            <img src="icons/Batch.png"
                             alt="Load ‘em Up!" />
                            <p className="feature_name semibold text_grey">Load ‘em Up!</p>
                            <p className="feature_details regular text_grey"> Batch processing feature allows you to watermark an entire photoshoot or video series in just one step.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="container-fluid">
                ...
                <div className="tab_section">
                    ...
                    id="pills-tab" role="tablist">
                        ...
                        <li className="nav-item">
                            <a className="nav-link" id="HIW_Video" data-toggle="pill" href="#pills-video" role="tab" aria-controls="pills-video" aria-selected="false">Video</a>
                        </li>
                        <li className="nav-item">
                            <a className="nav-link" id="HIW_Live" data-toggle="pill" href="#pills-live" role="tab" aria-controls="pills-live" aria-selected="false">Live Streaming</a>
                        </li>
                    </ul>
                    <div className="tab-content"
                     id="pills-tabContent">
                        <div className="tab-pane fade show active" id="pills-images"
                        ...
                        <div className="tab-pane fade" id="pills-live" role="tabpanel"
                         aria-labelledby="pills-live">
                            <div className="row">
                                ...
                                <div className="col-sm-12 col-md-6 col-lg-6 tab_mobile">
                                    <div className="step">
                                        <a className="active-tab" onclick="Imagechange_live(1)"
        ...
        <div className="container_settings" id="watchTutorial">
            <div className="tutorial_content">
                <a className="imp_play_icon request-loader" href="#">
                    <img className="img-fluid" src="icons/play-button.png" alt="Play" /></a>
                <h2 className="bold">Watch The Tutorial</h2>
                <p className="section_sub_heading regular">Lorem Ipsum is simply dummy text of the printing and typesetting industry.<br /> Lorem Ipsum has been
                    the industry's standard dummy text ever since the 1500s,</p>
            </div>
        </div>

        {/* <div className="container_settings" id="appScreenShots">
            <div className="container-fluid">
                <h2 className="section_heading text_grey">App Screenshots</h2>
                <p className="section_sub_heading text_grey"> ImageMark Pro was developed with the help of video journalists, photographers, to provide a flexible and intuitive video and
                    photo marking solution for professionals or newbies.</p>
                <div className="tab_section">
                    <ul className="nav nav-pills justify-content-center" id="pills-tab-2" role="tablist">
                        <li className="nav-item">
                            <a className="nav-link active" id="Apps_Images" data-toggle="pill" href="#pills-appImages" role="tab" aria-controls="pills-appImages" aria-selected="true">Image</a>
                        </li>
                        <li className="nav-item">
                            <a className="nav-link" id="Apps_Video" data-toggle="pill" href="#pills-appVideo" role="tab" aria-controls="pills-appVideo" aria-selected="false">Video</a>
                        </li>
                        <li className="nav-item">
                            <a className="nav-link" id="Apps_Live" data-toggle="pill" href="#pills-appLive" role="tab" aria-controls="pills-appLive" aria-selected="false">Live Streaming</a>
                        </li>
                    </ul>
                    <div className="tab-content" id="pills-tabContent">
                        <div className="tab-pane fade show active" id="pills-appImages" role="tabpanel" aria-labelledby="pills-appImages">
                          <div className="row">
                            2
                            </div>
                        </div>
                        <div className="tab-pane fade" id="pills-appVideo" role="tabpanel" aria-labelledby="pills-appVideo">
                            <div className="row">
                            2
                            </div>
                        </div>
                        <div className="tab-pane fade" id="pills-appLive" role="tabpanel" aria-labelledby="pills-appLive">
                            <div className="row">
                            3
                            </div>
                        </div>
                ...
                <div id="carouselTestimonials" className="carousel slide" data-ride="carousel">
                    <div className="carousel-inner">
                        <div className="carousel-item active">
                            ...
                            <p className="testimonial medium text_grey lh-35">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                    ...
                    <a className="carousel-control-prev" href="#carouselTestimonials"
                     role="button" data-slide="prev">
                        <span className="carousel-control-prev-icon" aria-hidden="true"></span>
                        <span className="sr-only">Previous</span>
                    </a>
                    <a className="carousel-control-next" href="#carouselTestimonials"
        ...
        <div className="container_settings" id="ourBlogs">
            <div className="container-fluid">
                ...
                <p className="section_sub_heading text_grey"> ImageMark Pro
                ...
                <div className="row blogs-conatiner">
                    ...
                    <div className="col-sm-5 col-md-5 col-lg-3">
                        <div className="blog-card">
                            ...
                            <div className="blog-div">
                                <p className="published-date">24 Dec, 2020 <span><i>By Admin</i></span></p>
                                <p className="blog-title medium text_grey">Lorem Ipsum is simply dummy text of the printing.</p>
                                <p className="blog-content text_grey truncate-overflow">Lorem Ipsum has been the industry's standard dummy text.Lorem Ipsum has been the industry's standard dummy text.</p>
                                <a className="text_blue" href="#readMore">Read more</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="col-sm-5 col-md-4 col-lg-3 hide_On_md">
                        <div className="blog-card">
                            <img className="blog-image" src="images/blog_image.png" 
                ...
                <div className="cta-div">
                    <a className="view_more text_grey" href="#allBlogs">VIEW MORE</a>
                </div>
            </div>
        </div>
        ...
        <div className="lightBlue_bg container_settings">
            <div className="container-fluid">
                ...
                <p className="section_sub_heading text_grey"> ImageMark Pro was 
                ...
                <div className="row news-container">
                    <div className="col-sm-12 col-md-5 col-lg-5 news-image">
                        <div className="news-details">
                            ...
                            <p className="news_headline text_white semibold">Twitter 
                        ...
                        <div className="news-div">
                            <a href="#goToNews" className="more-news">
                                <div className="news">
                                    ...
                                    <p className="news_headline text_grey semibold">Top AI
                            ...
                            <a href="#goToNews" className="more-news">
                                <div className="news">
                                    ...
                                    <p className="news_headline text_grey semibold">Deepfakes are coming. We’re not ready.</p>
                                </div>
                            </a>
                            <a href="#goToNews" className="more-news">
                                <div className="news">
                                    ...
                                    <p className="news_headline text_grey semibold">Twitter drafted a deepfake policy and wants you to
                                        weigh in - CNET</p>
                                </div>
                            </a>
                        </div>
        ...
        <div className="container_settings" id="aboutUs">
            <div className="container-fluid">
                ...
                <p className="section_sub_heading text_grey"> This video and photo 
                ...
                <div className="row profile_container">
                    ...
                    <div className="col-sm-5 col-md-5 col-lg-3">
                        <div className="profile_card">
                            <div className="image-container">
                                <img className="profile_image Grant_W" 
                                src="images/default_profile_image.png" alt="Grant Witham Image Mark Pro" />
                            </div>
                            <div className="profile_details">
                                <p className="profile_name bold text_grey">Grant Witham</p>
                                <p className="profile_designation text_grey regular">Co Founder, Tech Entrepreneur,
                    ...
                    <div className="col-sm-5 col-md-5 col-lg-3">
                        <div className="profile_card">
                            <div className="image-container">
                                <img className="profile_image Jerry_G" src="images/default_profile_image.png"
                                 alt="Gerardo ‘Jerry’ Gonzalez Image Mark Pro" />
                            </div>
                            <div className="profile_details">
                                <p className="profile_name bold text_grey">Gerardo ‘Jerry’ Gonzalez</p>
                                <p className="profile_designation text_grey regular">Co Founder, Visionary in Chief, Former
                    ...
                    <div className="col-sm-5 col-md-4 col-lg-3">
                        <div className="profile_card">
                            <div className="image-container">
                                <img className="profile_image Rodolfo_G"
                                 src="images/default_profile_image.png" alt="Rodolfo Gonzalez Image Mark Pro" />
                            </div>
                            <div className="profile_details">
                                <p className="profile_name bold text_grey">Rodolfo Gonzalez</p>
                                <p className="profile_designation text_grey regular">Partner, Tech Consultant,
            ...
            <div className="container-fluid">
                <div className="row">
                    <div className="col-sm-12 col-md-12 col-lg-3">
                        <a href="#about"><img className="footer_logo" src="images/IMP_Logo.png"
                         alt="Image Mark Pro" /></a>
                        <p className="imp_address">PO Box 220688,<br />Newhall CA 91322.</p>
                    </div>
                ...
                <div className="row">
                    <div className="col-sm-12 col-md-8 col-lg-8 terms_and_condition">
                        ...
                        <a className="policy_links" href="#">Privacy Policy</a>
                        <a className="policy_links" href="#">Subscription Details</a>
                    </div>
